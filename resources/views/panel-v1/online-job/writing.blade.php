...
@section('main', 'Writing Management')
@section('link')
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td class="" style="">
                                            <div class="d-flex align-items-center">
                                                <a data-bs-toggle="modal" data-bs-target="#edit{{ $find->id }}"
                                                    class="text-body delete-record">
                                                    <i class="ti ti-edit x`ti-sm mx-2"></i>
                                                </a>

                                                <a data-bs-toggle="modal" data-bs-target="#deleteModal{{ $find->id }}"
                                                    class="text-body delete-record">
                                                    <i class="ti ti-trash x`ti-sm mx-2"></i>
                                                </a>
                                            </div>
                                            <div class="modal fade" data-bs-backdrop='static'
                                                id="deleteModal{{ $find->id }}" tabindex="-1" aria-hidden="true">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="second">
                                                                    <a class="btn text-center"
                                                                        href="{{ route('dashboard-writing-delete', $find->id) }}">Delete</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="modal fade" data-bs-backdrop='static' id="edit{{ $find->id }}"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('dashboard-writing-edit', $find->id) }}"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col mb-3">
                                                                        ...
                                                                        <textarea class="form-control" name="instructions" id="" cols="30" rows="10" required>{{ $find->instructions }}</textarea>
                                                                    </div>
                                                                </div>
                ...
                <div class="modal fade" id="addNewBus" data-bs-backdrop='static' tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('dashboard-writing-create') }}" id="addBusForm" method="POST"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col mb-3">
                                            ...
                                            <textarea class="form-control" name="instructions" id="" cols="30" rows="10" required></textarea>
                                        </div>
                                    </div>
