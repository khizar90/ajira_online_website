...
@section('title', 'Content Creation Reuqest')
@section('main', 'Content Creation Reuqest Management')
@section('link')
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-start align-items-center user-name">
                                                ...
                                                <div class="d-flex flex-column"><span
                                                        class="fw-semibold user-name-text">{{ $item->content->name }}
                                                    </span>
                                                </div>
                                        ...
                                        <td>
                                            {{ $item->content->job_count }}
                                        </td>
                                        <td>
                                            {{ $item->content->price_per_job }}
                                        </td>
                                        <td>
