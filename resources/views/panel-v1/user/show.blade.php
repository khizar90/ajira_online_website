                                                                ...
                                                                <div class="d-flex align-items-start">
                                                                    ...
                                                                    <div class="ms-auto">
                                                                        ...
                                                                        @if ($item->status == 'pending')
                                                                            <a href="" class="badge rounded bg-label-success"
                                                                                data-bs-toggle="modal"
                                                                                data-bs-target="#deleteModal{{ $item->id }}">Approve</a>
                                                                                    ...
                                                                                    <div class="modal-content verifymodal">
                                                                                        <div class="modal-header">
                                                                                            <div class="modal-title"
                                                                                                id="modalCenterTitle">Are
                                                                                                you
                                                                                                sure you want to give point
                                                                                                to user?
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="modal-body">
                                                                                            <div class="body">After
                                                                                                giving point user can
                                                                                                withdraw this
                                                                                                point.</div>
                                                                                        </div>
                                                                                        <hr class="hr">
                                                                                            ...
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="second">
                                                                                                    <a class="btn text-center"
                                                                                                        href="{{ route('dashboard-point-request-approve', $item->id) }}">Approve</a>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
