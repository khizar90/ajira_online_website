...
<tr class="odd">
    ...
    <td class="sorting_1">
        <div class="d-flex justify-content-start align-items-center user-name">
            ...
            <div class="d-flex flex-column"><a
                    href="{{ route('dashboard-profile', $user->uuid) }}"
                    class="text-body text-truncate"><span
                        class="fw-semibold user-name-text">{{ $user->name }}
                    </span></a>
                <small
                    class="text-muted">&#64;{{ $user->email != '' ? $user->email : 'No Email' }}</small>
            </div>
        </div>
    ...
    @if ($user->status == 1)
        <td>
            <button class="badge bg-label-success btn">Approved</button>
        </td>
    @else
        <td>
    ...
    <td class="" style="">
        <div class="d-flex align-items-center">
            <a href="{{ route('dashboard-profile', $user->uuid) }}"
        ...
        <div class="modal fade" data-bs-backdrop='static'
            id="verifyModal{{ $user->uuid }}" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                <div class="modal-content verifymodal">
                    <div class="modal-header">
                        <div class="modal-title" id="modalCenterTitle">Are you
                            sure you want to approve this account?
                        </div>
                    </div>
                    <div class="modal-body">
                        <div class="body">After approving user can use the app.</div>
                    </div>
                    <hr class="hr">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="second">
                                <a class="btn text-center" href="{{ route('dashboard-approve-user',$user->uuid) }}">Approve</a>
                            </div>
                        </div>
                    </div>
